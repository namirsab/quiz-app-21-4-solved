...
export function createCardComponent(cardData) {
  ...
  bookmarkIcon.addEventListener("click", () => {
    bookmarkIcon.classList.toggle("quiz-card__bookmark--toggled");
  });
  ...
  showHideAnswerButton.addEventListener("click", () => {
    ...
    showHideAnswerButton.classList.toggle("quiz-card__button--toggled");
    showHideAnswerButton.textContent = answerText.hidden
      ? "Show Answer"
      : "Hide Answer";
